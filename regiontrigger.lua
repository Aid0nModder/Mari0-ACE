...
function regiontrigger:hitboxdraw()
	love.graphics.setColor(234, 160, 45, 111)
	love.graphics.rectangle("fill", ((self.rx*16)-xscroll*16)*scale, (((self.ry-0.5)*16)-yscroll*16)*scale, (self.rw*16)*scale, (self.rh*16)*scale)
